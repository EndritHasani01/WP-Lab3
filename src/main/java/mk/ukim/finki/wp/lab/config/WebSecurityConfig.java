    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .permitAll()
                        .requestMatchers("/admin/**", "/songs/delete/**", "/songs/add-form/**", "/songDetails/**")
                        .hasRole("ADMIN")
                        .requestMatchers(".songs/edit/..")
                        .hasAnyRole("ADMIN","USER")
                        .anyRequest() // meaning any request for editing, adding, ..., needs at least login
                        .authenticated()
                )
                .formLogin((form) -> form
                        .loginPage("/login")
